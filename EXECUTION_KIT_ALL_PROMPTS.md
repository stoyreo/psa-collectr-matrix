# PSA × Collectr Tracer — Complete Execution Kit
**All 8 Agent Prompts Ready to Launch**

---

## HOW TO USE THIS KIT

1. **Open multiple Cowork sessions** (one per agent, or queue them)
2. **Copy each prompt below** (copy the entire text block)
3. **Paste into a new Cowork chat**
4. **Agent runs automatically** → produces deliverables
5. **Collect outputs** → feed to next wave

**Wave execution:**
- **Wave 1 (parallel):** Agents 1 + 2 (no wait)
- **Wave 2 (parallel, after Wave 1):** Agents 5 + 6 (no wait)
- **Wave 3 (parallel, after Waves 1–2):** Agents 3 + 7 + 4 (run simultaneously)
...
# WAVE 2: STRATEGY & MARKET LOGIC (Days 3–5)
...
# WAVE 3: DESIGN & IMPLEMENTATION (Days 5–15)
...
1. **Open 8 browser tabs** (one per agent) or **queue in Cowork**
2. **Copy each prompt above** (entire code block)
3. **Paste into a new Cowork chat** → agent runs automatically
4. **Collect outputs** as agents complete

**Wave Timing:**
- **Wave 1 (Days 1–3):** Launch Prompts 1 + 2 in parallel (no wait)
- **Review outputs:** 30 min
- **Wave 2 (Days 3–5):** Launch Prompts 5 + 6 in parallel (feed Wave 1 outputs)
- **Review outputs:** 30 min
- **Wave 3 (Days 5–15):** Launch Prompts 3 + 7 + 4 in parallel (feed Waves 1–2)
- **Review outputs:** 1 hour
- **Wave 4 (Days 15–21):** Launch Prompt 8 (feed Wave 3 outputs)
...
- ✅ Feature priority matrix
- ✅ 3 pricing tiers
- ✅ Revised navigation IA
- ✅ 4-step onboarding wizard
- ✅ Demo portfolio spec (15 cards)
- ✅ Mobile IA
...
- ✅ POP integration architecture
- ✅ Premium feature ranking
- ✅ Revenue model projection
- ✅ Freemium guardrails

**Wave 3 Output:**
- ✅ Dashboard redesign comp
- ✅ Signal badge + tooltip design
- ✅ Confidence visual redesign
- ✅ Scenario explainer UI
- ✅ Mobile card layout
- ✅ Alert center UI
...
**All 8 prompts ready. You're armed to execute the full 21-day product transformation.**
